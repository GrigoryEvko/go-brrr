...
noeq type eval_state = {
  es_env      : env;              (* Local variable bindings *)
  es_heap     : heap;             (* Heap for mutable values *)
  es_closures : closure_store;    (* Stored closures *)
  es_handlers : handler_stack;    (* Active effect handlers *)
