...
\begin{enumerate}
    ...
    \item \textbf{Session types}: Following Honda 1998/2008, channel effects include session type operations (select, branch, delegate) for typed communication protocols.
\end{enumerate}
