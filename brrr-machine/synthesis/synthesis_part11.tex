...
\begin{fstarcode}[title={IR Statements --- Effectful Operations (Part 2: Concurrency)}]
  ...
  (* Channel operations --- Honda 1998 (binary) / Honda 2008 (multiparty) session type primitives.
     Note: Honda 1998 is sound; Honda 2008 proofs corrected by Scalas & Yoshida 2019. *)
...
\textbf{Note on Foundations:} Honda 1998 (binary session types) is well-established and has been mechanized. Honda 2008 (multiparty) proofs were corrected by Scalas \& Yoshida 2019; see Part XIV Section 14.3.1.
\end{pillarbox}
