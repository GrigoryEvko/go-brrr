...
//!
//! ```
//! use go_brrr::simd::{sum_f32, dot_product, count_byte, all_equal, find_newlines};
//!
...
///
/// ```
/// use go_brrr::simd::find_newlines;
///
/// let text = b"line1\nline2\nline3";
...
///
/// ```
/// use go_brrr::simd::cosine_similarity;
///
/// let a = [1.0_f32, 0.0];
/// let b = [1.0_f32, 0.0];
...
///
/// ```
/// use go_brrr::simd::find_matching_u32;
///
...
///
/// ```
/// use go_brrr::simd::find_matching_u32_into;
///
/// let data = [1u32, 5, 3, 5, 5, 2, 7, 5, 9, 5];
