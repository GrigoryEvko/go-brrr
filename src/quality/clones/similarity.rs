...
//!
//! ```ignore
//! use go_brrr::quality::clones::similarity::{
...
///
/// ```ignore
/// use go_brrr::quality::clones::similarity::cosine_similarity;
///
/// let a = vec![1.0, 0.0, 0.0];
...
///
/// ```ignore
/// use go_brrr::quality::clones::similarity::euclidean_distance;
///
...
///
/// ```ignore
/// use go_brrr::quality::clones::similarity::compute_pairwise_similarities;
///
/// let embeddings = vec![
///     vec![1.0, 0.0, 0.0],
...
///
/// ```ignore
/// use go_brrr::quality::clones::similarity::find_similar;
///
