...
/// ```
/// use std::path::Path;
/// use go_brrr::util::path::normalize_path;
///
...
/// ```no_run
/// use std::path::Path;
/// use go_brrr::util::path::get_project_root;
///
...
/// ```no_run
/// use std::path::Path;
/// use go_brrr::util::path::require_exists;
///
...
/// ```no_run
/// use std::path::Path;
/// use go_brrr::util::path::require_file;
///
...
/// ```no_run
/// use std::path::Path;
/// use go_brrr::util::path::require_directory;
///
...
/// ```no_run
/// use std::path::Path;
/// use go_brrr::util::path::detect_project_language;
///
