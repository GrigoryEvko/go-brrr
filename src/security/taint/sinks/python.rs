...
fn add_sql_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::sql("cursor.executescript", "SQLite cursor executescript")
        .with_severity(10)); // executescript is especially dangerous
    ...
    registry.add(Sink::sql("cursor.executemany", "psycopg2 cursor executemany"));
    registry.add(Sink::sql("cursor.copy_from", "psycopg2 COPY FROM"));
    registry.add(Sink::sql("cursor.copy_to", "psycopg2 COPY TO"));
    registry.add(Sink::sql("cursor.copy_expert", "psycopg2 COPY EXPERT")
        .with_severity(10));
    ...
    registry.add(Sink::sql("connection.execute", "SQLAlchemy connection execute"));
    registry.add(Sink::sql("session.execute", "SQLAlchemy session execute"));
    registry.add(Sink::sql("text(", "SQLAlchemy text() raw SQL")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::sql("TextClause", "SQLAlchemy TextClause"));

    // Django ORM
    registry.add(Sink::sql(".raw(", "Django ORM raw() query")
        .with_severity(9));
    registry.add(Sink::sql(".extra(", "Django ORM extra() (deprecated)")
        .with_severity(8)
        .with_tag("deprecated"));
    registry.add(Sink::sql("RawSQL(", "Django RawSQL expression"));
    registry.add(Sink::sql("connection.cursor().execute", "Django raw cursor execute"));
...
fn add_command_sinks(registry: &mut SinkRegistry) {
    // os module
    registry.add(Sink::command("os.system", "os.system() shell command")
        .with_severity(10));
    registry.add(Sink::command("os.popen", "os.popen() shell command")
        .with_severity(10));
    registry.add(Sink::command("os.popen2", "os.popen2() shell command")
        .with_severity(10));
    registry.add(Sink::command("os.popen3", "os.popen3() shell command")
        .with_severity(10));
    registry.add(Sink::command("os.popen4", "os.popen4() shell command")
        .with_severity(10));
    ...
    // subprocess module
    registry.add(Sink::command("subprocess.call", "subprocess.call()")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::command("subprocess.run", "subprocess.run()")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::command("subprocess.Popen", "subprocess.Popen()")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::command("subprocess.check_call", "subprocess.check_call()")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::command("subprocess.check_output", "subprocess.check_output()")
        .with_dangerous_params(vec![0]));
    registry.add(Sink::command("subprocess.getoutput", "subprocess.getoutput()")
        .with_severity(10));
    registry.add(Sink::command("subprocess.getstatusoutput", "subprocess.getstatusoutput()")
        .with_severity(10));

    // asyncio subprocess
    registry.add(Sink::command("asyncio.create_subprocess_shell", "asyncio shell subprocess")
        .with_severity(10));
    registry.add(Sink::command("asyncio.create_subprocess_exec", "asyncio exec subprocess"));

    // Deprecated commands module (Python 2)
    registry.add(Sink::command("commands.getoutput", "commands.getoutput() (deprecated)")
        .with_severity(10)
        .with_tag("deprecated"));
    registry.add(Sink::command("commands.getstatusoutput", "commands.getstatusoutput() (deprecated)")
        .with_severity(10)
        .with_tag("deprecated"));

    // pty module
    registry.add(Sink::command("pty.spawn", "pty.spawn() terminal spawn")
        .with_severity(10));
...
fn add_code_execution_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::code_exec("eval(", "eval() code execution")
        .with_severity(10));
    registry.add(Sink::code_exec("exec(", "exec() code execution")
        .with_severity(10));
    registry.add(Sink::code_exec("compile(", "compile() code compilation")
        .with_severity(9));
    registry.add(Sink::code_exec("__import__(", "Dynamic import")
        .with_severity(8));
    registry.add(Sink::code_exec("importlib.import_module", "Dynamic module import")
        .with_severity(8));

    // Code object manipulation
    registry.add(Sink::code_exec("types.FunctionType", "Dynamic function creation")
        .with_severity(9));
    registry.add(Sink::code_exec("types.CodeType", "Code object creation")
        .with_severity(9));

    // AST-based code execution
    registry.add(Sink::code_exec("ast.literal_eval", "ast.literal_eval() (safer but limited)")
        .with_severity(4));
}
...
fn add_path_sinks(registry: &mut SinkRegistry) {
    // Built-in open
    registry.add(Sink::path("open(", "open() file access")
        .with_dangerous_params(vec![0]));
    ...
    registry.add(Sink::path("os.path.join", "os.path.join() path construction")
        .with_severity(5)); // Less dangerous if used correctly
    ...
    registry.add(Sink::path("os.makedirs", "os.makedirs() recursive directory creation"));
    registry.add(Sink::path("os.rmdir", "os.rmdir() directory removal"));
    registry.add(Sink::path("os.removedirs", "os.removedirs() recursive directory removal"));
    ...
    registry.add(Sink::path("os.symlink", "os.symlink() symbolic link creation"));
    registry.add(Sink::path("os.readlink", "os.readlink() read symbolic link"));
    ...
    // pathlib module
    registry.add(Sink::path("pathlib.Path", "pathlib.Path() construction")
        .with_severity(5));
    registry.add(Sink::path("Path(", "pathlib.Path() construction")
        .with_severity(5));
    ...
    registry.add(Sink::path("shutil.copy2", "shutil.copy2() file copy with metadata"));
    registry.add(Sink::path("shutil.copyfile", "shutil.copyfile() content copy"));
    registry.add(Sink::path("shutil.copytree", "shutil.copytree() directory copy"));
    registry.add(Sink::path("shutil.move", "shutil.move() file/dir move"));
    registry.add(Sink::path("shutil.rmtree", "shutil.rmtree() recursive delete")
        .with_severity(9));
    registry.add(Sink::path("shutil.chown", "shutil.chown() ownership change"));
    registry.add(Sink::path("shutil.make_archive", "shutil.make_archive() archive creation"));
    registry.add(Sink::path("shutil.unpack_archive", "shutil.unpack_archive() archive extraction")
        .with_severity(9)); // Zip slip vulnerability
    ...
    registry.add(Sink::path("aiofiles.open", "aiofiles.open() async file open"));

    // tarfile/zipfile (archive extraction)
    registry.add(Sink::path("tarfile.open", "tarfile.open() tar archive")
        .with_severity(8));
    registry.add(Sink::path("zipfile.ZipFile", "zipfile.ZipFile() zip archive")
        .with_severity(8));
    registry.add(Sink::path(".extract(", "Archive extract()")
        .with_severity(9)); // Zip slip
    registry.add(Sink::path(".extractall(", "Archive extractall()")
        .with_severity(9)); // Zip slip
}
...
fn add_xss_sinks(registry: &mut SinkRegistry) {
    // Flask/Jinja2
    registry.add(Sink::xss("Markup(", "Flask Markup() unescaped HTML")
        .with_severity(8));
    registry.add(Sink::xss("render_template_string", "Jinja2 render_template_string() SSTI risk")
        .with_severity(9));
    registry.add(Sink::xss("jinja2.Template", "Direct Jinja2 Template()"));
    registry.add(Sink::xss("make_response", "Flask make_response()")
        .with_severity(5));
    registry.add(Sink::xss("Response(", "Direct Response() creation")
        .with_severity(5));
    registry.add(Sink::xss("jsonify", "Flask jsonify() (usually safe)")
        .with_severity(3));

    // Django
    registry.add(Sink::xss("mark_safe", "Django mark_safe() unescaped HTML")
        .with_severity(8));
    registry.add(Sink::xss("SafeString", "Django SafeString() unescaped HTML")
        .with_severity(8));
    registry.add(Sink::xss("format_html", "Django format_html() (partially safe)")
        .with_severity(4));
    registry.add(Sink::xss("HttpResponse(", "Django HttpResponse()")
        .with_severity(5));

    // FastAPI/Starlette
    registry.add(Sink::xss("HTMLResponse", "FastAPI HTMLResponse()")
        .with_severity(6));
    registry.add(Sink::xss("Response(", "Starlette Response()")
        .with_severity(5));
}
...
fn add_ssrf_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::ssrf("requests.delete", "requests.delete() HTTP DELETE"));
    ...
    registry.add(Sink::ssrf("requests.options", "requests.options() HTTP OPTIONS"));
    registry.add(Sink::ssrf("requests.request", "requests.request() generic HTTP"));
    ...
    // urllib
    registry.add(Sink::ssrf("urllib.request.urlopen", "urllib.request.urlopen()"));
    registry.add(Sink::ssrf("urllib.request.Request", "urllib.request.Request()"));
    registry.add(Sink::ssrf("urllib.request.urlretrieve", "urllib.request.urlretrieve()"));
    registry.add(Sink::ssrf("urllib2.urlopen", "urllib2.urlopen() (Python 2)")
        .with_tag("deprecated"));
    registry.add(Sink::ssrf("urllib2.Request", "urllib2.Request() (Python 2)")
        .with_tag("deprecated"));
    ...
    // aiohttp
    registry.add(Sink::ssrf("aiohttp.ClientSession", "aiohttp ClientSession()"));
    registry.add(Sink::ssrf("ClientSession.get", "aiohttp ClientSession.get()"));
    registry.add(Sink::ssrf("ClientSession.post", "aiohttp ClientSession.post()"));
    registry.add(Sink::ssrf("ClientSession.request", "aiohttp ClientSession.request()"));

    // http.client
    registry.add(Sink::ssrf("http.client.HTTPConnection", "http.client HTTPConnection()"));
    registry.add(Sink::ssrf("http.client.HTTPSConnection", "http.client HTTPSConnection()"));
    registry.add(Sink::ssrf("HTTPConnection.request", "HTTPConnection.request()"));
...
fn add_deserialization_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(
        Sink::new("pickle.load", SinkCategory::Deserialization)
            .with_severity(10),
    );
    registry.add(
        Sink::new("pickle.Unpickler", SinkCategory::Deserialization)
            .with_severity(10),
    );
    registry.add(
    ...
    registry.add(
        Sink::new("yaml.unsafe_load", SinkCategory::Deserialization)
            .with_severity(10),
    );
    registry.add(
        Sink::new("yaml.full_load", SinkCategory::Deserialization)
            .with_severity(8),
    );
    ...
    // marshal (dangerous)
    registry.add(
        Sink::new("marshal.loads", SinkCategory::Deserialization)
            .with_severity(9),
    );
    registry.add(
        Sink::new("marshal.load", SinkCategory::Deserialization)
            .with_severity(9),
    );

    // shelve (uses pickle internally)
    registry.add(
        Sink::new("shelve.open", SinkCategory::Deserialization)
            .with_severity(8),
    );

    // dill (pickle extension)
    registry.add(
        Sink::new("dill.loads", SinkCategory::Deserialization)
            .with_severity(10),
    );
    registry.add(
        Sink::new("dill.load", SinkCategory::Deserialization)
            .with_severity(10),
    );

    // jsonpickle
    registry.add(
        Sink::new("jsonpickle.decode", SinkCategory::Deserialization)
            .with_severity(9),
    );

    // cloudpickle
    registry.add(
        Sink::new("cloudpickle.loads", SinkCategory::Deserialization)
            .with_severity(10),
    );
}
...
fn add_ldap_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::ldap("ldap.search_ext_s", "python-ldap search_ext_s()"));
...
fn add_xpath_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::xpath("ElementTree.findtext", "ElementTree findtext()"));
...
fn add_xml_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(
        Sink::new("xml.etree.ElementTree.fromstring", SinkCategory::XmlInjection)
            .with_severity(7),
    );
    registry.add(
        Sink::new("ElementTree.parse", SinkCategory::XmlInjection)
            .with_severity(7),
    );
    registry.add(
        Sink::new("ET.parse", SinkCategory::XmlInjection)
            .with_severity(7),
    );
    registry.add(
        Sink::new("ET.fromstring", SinkCategory::XmlInjection)
            .with_severity(7),
    );

    // lxml (safe by default but can be configured unsafely)
    registry.add(
        Sink::new("lxml.etree.parse", SinkCategory::XmlInjection)
            .with_severity(6),
    );
    registry.add(
        Sink::new("lxml.etree.fromstring", SinkCategory::XmlInjection)
            .with_severity(6),
    );
    registry.add(
        Sink::new("lxml.etree.XML", SinkCategory::XmlInjection)
            .with_severity(6),
    );

    // xml.dom.minidom
    registry.add(
        Sink::new("xml.dom.minidom.parse", SinkCategory::XmlInjection)
            .with_severity(8),
    );
    registry.add(
        Sink::new("xml.dom.minidom.parseString", SinkCategory::XmlInjection)
            .with_severity(8),
    );

    // xml.sax (vulnerable)
    registry.add(
        Sink::new("xml.sax.parse", SinkCategory::XmlInjection)
            .with_severity(8),
    );
    registry.add(
        Sink::new("xml.sax.parseString", SinkCategory::XmlInjection)
            .with_severity(8),
    );
}
...
fn add_redirect_sinks(registry: &mut SinkRegistry) {
    // Flask
    registry.add(
        Sink::new("redirect(", SinkCategory::OpenRedirect)
            .with_dangerous_params(vec![0]),
    );
    registry.add(
        Sink::new("flask.redirect", SinkCategory::OpenRedirect)
            .with_dangerous_params(vec![0]),
    );
    ...
    // FastAPI/Starlette
    registry.add(
        Sink::new("RedirectResponse", SinkCategory::OpenRedirect)
            .with_dangerous_params(vec![0]),
    );
}
...
fn add_template_sinks(registry: &mut SinkRegistry) {
    // Jinja2
    registry.add(
        Sink::new("jinja2.Template", SinkCategory::TemplateInjection)
            .with_severity(9),
    );
    registry.add(
        Sink::new("Template(", SinkCategory::TemplateInjection)
            .with_severity(9),
    );
    registry.add(
        Sink::new("Environment.from_string", SinkCategory::TemplateInjection)
            .with_severity(9),
    );

    // Mako
    registry.add(
        Sink::new("mako.template.Template", SinkCategory::TemplateInjection)
            .with_severity(9),
    );

    // string.Template (limited injection risk)
    registry.add(
        Sink::new("string.Template", SinkCategory::TemplateInjection)
            .with_severity(4),
    );

    // Django templates
    registry.add(
        Sink::new("django.template.Template", SinkCategory::TemplateInjection)
            .with_severity(6), // Django templates are sandboxed
    );

    // Tornado templates
    registry.add(
        Sink::new("tornado.template.Template", SinkCategory::TemplateInjection)
            .with_severity(8),
    );
}
...
fn add_log_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(Sink::log("print(", "print() to stdout")
        .with_severity(2));
}
...
fn add_header_sinks(registry: &mut SinkRegistry) {
    // Flask
    registry.add(Sink::header("response.headers[", "Flask response header setting"));
    registry.add(Sink::header("make_response", "Flask make_response() with headers"));
...
fn add_email_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(
        Sink::new("smtplib.send_message", SinkCategory::EmailHeaderInjection),
    );

    // email.message
    registry.add(
        Sink::new("email.message.Message", SinkCategory::EmailHeaderInjection),
    );
    registry.add(
        Sink::new("email.mime", SinkCategory::EmailHeaderInjection)
            .with_severity(5),
    );

    // Django mail
    registry.add(
        Sink::new("django.core.mail.send_mail", SinkCategory::EmailHeaderInjection),
    );
    registry.add(
        Sink::new("django.core.mail.EmailMessage", SinkCategory::EmailHeaderInjection),
    );
}
...
fn add_nosql_sinks(registry: &mut SinkRegistry) {
    ...
    registry.add(
        Sink::new("collection.find", SinkCategory::NoSqlInjection)
            .with_dangerous_params(vec![0]), // query filter
    );
    registry.add(
    ...
    // motor (async MongoDB)
    registry.add(
        Sink::new("motor.find", SinkCategory::NoSqlInjection)
            .with_dangerous_params(vec![0]),
    );

    // redis (command injection possible)
    registry.add(
        Sink::new("redis.execute_command", SinkCategory::NoSqlInjection)
            .with_severity(8),
    );
    registry.add(
        Sink::new("redis.eval", SinkCategory::NoSqlInjection)
            .with_severity(9), // Lua script execution
    );
}
...
mod tests {
    ...
    fn test_python_sql_sinks() {
        ...
        assert!(matches.iter().any(|s| s.category == SinkCategory::SqlInjection));
    }
