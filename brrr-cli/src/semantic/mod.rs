...
//!
//! ```no_run
//! use brrr::semantic::{extract_units, EmbeddingUnit, UnitKind};
//!
...
//!
//! ```no_run
//! use brrr::semantic::{extract_units, MAX_EMBEDDING_TOKENS};
//!
...
//!
//! ```no_run
//! use brrr::semantic::{detect_semantic_patterns, build_embedding_text};
//!
...
//!
//! ```
//! use brrr::semantic::{count_tokens, truncate_to_tokens};
//!
