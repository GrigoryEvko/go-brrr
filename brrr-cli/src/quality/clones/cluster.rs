...
//!
//! ```ignore
//! use brrr::quality::clones::cluster::{cluster_clones, CloneCluster};
//! use brrr::quality::clones::similarity::SimilarityPair;
//!
//! let pairs = vec![
...
///
/// ```ignore
/// use brrr::quality::clones::cluster::cluster_clones;
/// use brrr::quality::clones::similarity::{compute_pairwise_similarities, SimilarityPair};
///
...
///
/// ```ignore
/// use brrr::quality::clones::cluster::find_similar_approximate;
