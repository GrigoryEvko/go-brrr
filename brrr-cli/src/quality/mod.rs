...
//!
//! ```ignore
//! use brrr::quality::clones::{detect_clones, CloneConfig};
//!
...
//!
//! ```ignore
//! use brrr::quality::clones::{detect_structural_clones, StructuralCloneConfig};
//!
...
//!
//! ```ignore
//! use brrr::quality::clones::{detect_semantic_clones, SemanticCloneConfig};
//!
...
//!
//! ```ignore
//! use brrr::quality::smells::{detect_long_methods, LongMethodConfig};
//!
...
//!
//! ```ignore
//! use brrr::quality::smells::{detect_god_classes, GodClassConfig};
//!
