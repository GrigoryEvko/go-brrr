...
impl ScanConfig {
    ...
    ///
    /// ```no_run
    /// use brrr::callgraph::scanner::ScanConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use brrr::callgraph::scanner::{ScanConfig, ErrorHandling};
    ///
...
///
/// ```no_run
/// use brrr::callgraph::scanner::{ProjectScanner, ScanConfig};
///
...
impl ProjectScanner {
    ...
    ///
    /// ```no_run
    /// use brrr::callgraph::scanner::ProjectScanner;
    ///
    /// let scanner = ProjectScanner::new("/path/to/project").unwrap();
